...
// PacketScore rates a received packet from 0 (no chance of success) to 1, as
// the firmware's RadioLibWrapper::packetScoreInt does. Feed it to
// node.RxDelayForScore to reproduce the firmware's rxdelay.
